...
@implementation Sticker_SQLiteManager

@synthesize _database;

static Sticker_SQLiteManager *prj_Sqlite_Massager = nil;

+ (Sticker_SQLiteManager *)shareStance
{
    if (prj_Sqlite_Massager == nil) {
        prj_Sqlite_Massager = [[Sticker_SQLiteManager alloc]init];
    }
